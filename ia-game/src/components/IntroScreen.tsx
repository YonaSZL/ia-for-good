...
const IntroScreen: React.FC<IntroScreenProps> = ({ onStart }) => {
  ...
  return (
    <motion.div
      ...
      animate="visible"
    >
      <motion.div className="mb-6 text-emerald-600" variants={itemVariants}>
        <img
      ...
      <motion.p
        ...
        variants={itemVariants}
      >
        Le destin d'une nation — peut-être du monde entier — repose entre vos
        mains. Chaque décision que vous prendrez façonnera l'avenir de
        Terranova. Mènerez-vous l'humanité vers une utopie solarpunk durable, ou
        vos décisions à court terme créeront-elles un monde de désastre
        environnemental ?
      </motion.p>
      ...
      <motion.p
        ...
        variants={itemVariants}
      >
        Vos choix auront des conséquences. Les ressources sont limitées, le
        temps presse, et les défis sont complexes. Bonne chance, leader.
      </motion.p>
    </motion.div>
  );
};
